...
out_dir    <- "derived_tables/outputs_afterEGU_results/RF_outputs_rawmem_fixed"
...
cat("\n--- Memory effect note ---\n")
cat("  Raw-lag results are in RF_outputs_rawmem_fixed/\n")
cat("  Anomaly-mem results are in RF_outputs_fixed/\n")
