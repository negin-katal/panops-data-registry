...
# ============================================================
# RUN 22: Per-site SHAP values (TreeSHAP via treeshap)
#         for M04_12m (C+T+D) and M08_12m (C+T+D+Memory)
#
# For each LOSO fold:
#   1. Train RF on all sites EXCEPT test_site
#   2. Compute exact TreeSHAP for test_site observations
#   3. Save mean |SHAP| per variable per test_site
#
# Output: RF_outputs_fixed/RF_site_shap_M04_M08.csv
#         (one row per test_site × response × model × variable)
# ============================================================
...
# ============================================================
# 1) Load and prepare data (same pipeline as run_19)
# ============================================================
...
# ============================================================
# 2) Benchmark set (complete cases across M04 + M08)
# ============================================================
...
# ============================================================
# 3) Group lookup for each variable
# ============================================================
...
# ============================================================
# 4) Model specs: M04 and M08 only
# ============================================================
...
# ============================================================
# 5) LOSO loop — compute TreeSHAP per fold
# ============================================================
...
for (resp in RESPONSE_VARS) {
  for (spec_name in names(model_specs)) {
    ...
    for (i in seq_along(site_ids)) {
      ...
      # Compute exact TreeSHAP for test observations
      ...
      # Mean |SHAP| per variable for this test site
...
# ============================================================
# 6) Combine, add group labels, save
# ============================================================
