...
metrics_sources <- list(
  anomaly = "derived_tables/outputs_afterEGU_results/RF_outputs_anomaly_24mbench/RF_metrics_LOSO.csv",
  rawlag  = "derived_tables/outputs_afterEGU_results/RF_outputs_rawmem_24mbench/RF_metrics_LOSO.csv"
)
...
model_pairs <- list(
  ...
  list(base = "M09", dist = "M10",
       lbl_base = "M",         lbl_dist = "M + D")
)
