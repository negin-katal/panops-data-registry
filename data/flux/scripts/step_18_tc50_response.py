...
df_b1 = pd.read_csv('derived_tables/outputs_afterEGU_results/v10_tc50/v10_tc50_B1_lag1only.csv')
df_b2 = pd.read_csv('derived_tables/outputs_afterEGU_results/v10_tc50/v10_tc50_B2_lag1lag2.csv')
...
for response_var in response_vars:
    ...
    b1_file = f'derived_tables/outputs_afterEGU_results/v10_tc50/v10_tc50_B1_{response_var}.csv'
    ...
    b2_file = f'derived_tables/outputs_afterEGU_results/v10_tc50/v10_tc50_B2_{response_var}.csv'
