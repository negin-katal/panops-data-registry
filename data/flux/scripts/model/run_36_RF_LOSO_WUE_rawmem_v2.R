# v2 — 2026-06-30: rerun with fixed data (negative WUE→NA, CN-Sb1/2 outliers→NA, US-HB4 P anomalies→NA)
library(data.table)
library(ranger)
...
out_dir    <- "derived_tables/outputs_afterEGU_results/RF_outputs_rawmem_24mbench_WUE_v2"
