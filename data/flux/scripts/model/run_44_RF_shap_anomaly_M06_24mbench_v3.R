# v3 — 2026-07-07: SHAP computation for M06 (C+D+M) 24m window
library(data.table)
library(ranger)
library(treeshap)

# ============================================================
# TreeSHAP for M06 x 24m — ANOMALY MEMORY
# Model: M06_24m (C + D + M)
# All 5 EFPs: GPPsat, NEPmax, ETmax, uWUE, WUE
# Output: RF_outputs_anomaly_24mbench_v3/RF_site_shap_M06.csv
# ============================================================
...
# ============================================================
# 2) Compute SHAP for each EFP — M06 (C+D+M)
# ============================================================
...
for (resp in RESPONSE_VARS) {
  ...
  # Load trained RF model for M06
  model_path <- sprintf("derived_tables/outputs_afterEGU_results/RF_outputs_anomaly_24mbench_v3/RF_model_M06_24m_%s.rds", resp)
...
# Write output
out_file <- file.path(out_dir, "RF_site_shap_M06.csv")
