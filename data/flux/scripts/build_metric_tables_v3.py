...
ANOM_M = f"{BASE}/RF_outputs_anomaly_24mbench_v3/RF_metrics_LOSO.csv"
RAWM_M = f"{BASE}/RF_outputs_rawmem_24mbench_v3/RF_metrics_LOSO.csv"
ANOM_P = f"{BASE}/RF_outputs_anomaly_24mbench_v3/RF_predictions_LOSO.csv"
RAWM_P = f"{BASE}/RF_outputs_rawmem_24mbench_v3/RF_predictions_LOSO.csv"
MODEL_CSV = f"{BASE}/EFP_mortality_trait_hydro_combined_with_meteo_dist_lags_v3_harmonized.csv"
...
out1 = f"{TABLE}/table_RF_LOSO_results_v3.tex"
...
out2 = f"{TABLE}/table_RMSE_ratio_v3.tex"
