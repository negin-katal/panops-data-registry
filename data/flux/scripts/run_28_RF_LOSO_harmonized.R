#!/usr/bin/env Rscript
# ============================================================================
# RF Training: HARMONIZED LOSO (ALL MODELS ON SAME SITE-YEARS)
# ============================================================================
# Dataset: All models train on identical site-years for FAIR comparison
# B1: 65 site-years per response | B2: 62 site-years per response
# ============================================================================
...
cat("\n", strrep("=", 80), "\n", sep="")
cat("RF TRAINING: HARMONIZED LOSO - FAIR MODEL COMPARISON\n")
cat("All models use SAME site-years (n=65 for B1, n=62 for B2)\n")
cat(strrep("=", 80), "\n\n", sep="")
...
cat("\n", strrep("=", 80), "\n", sep="")
cat("✅ HARMONIZED RF TRAINING COMPLETE\n")
